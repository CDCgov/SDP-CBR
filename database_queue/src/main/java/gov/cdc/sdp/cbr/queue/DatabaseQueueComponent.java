...
public class DatabaseQueueComponent extends UriEndpointComponent {
  ...
  public String getCreateCommand(String tableName) {
    return ("CREATE TABLE IF NOT EXISTS " + tableName + " (id bigserial primary key,"
        ...
        + "batch_id varchar(255), payload text NOT NULL, cbr_recevied_time varchar (255) NOT NULL,"
        + "cbr_delivered_time varchar (255) default NULL, sender varchar (255) default NULL,"
        + "recipient varchar (255) default NULL, errorCode varchar (255) default NULL,"
