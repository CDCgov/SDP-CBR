...
public class MessageQueueEndpoint extends DefaultEndpoint {
    ...
    public MessageQueueEndpoint(String uri, Component component, DataSource ds, String tableName, int delay,
    ...
    public Producer createProducer() throws Exception {
        return new MessageQueueProducer(this, getEndpointUri(), dataSource, tableName);
    }
    ...
    public Consumer createConsumer(Processor processor) throws Exception {
        return new MessageQueueConsumer(this, dataSource, processor, tableName, delay, initialDelay, limit,
                maxAttempts);
    }
