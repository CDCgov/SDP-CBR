...
public class MessageQueueConsumer extends ScheduledBatchPollingConsumer {
    ...
    public MessageQueueConsumer(Endpoint endpoint, DataSource ds, Processor processor, String tn, int delay,
