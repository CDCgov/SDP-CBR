...
public class DatabaseQueueEndpoint extends DefaultEndpoint {
  ...
  public Consumer createConsumer(Processor processor) throws Exception {
    return new DatabaseQueueConsumer(this, dataSource, processor, tableName, delay, initialDelay, limit, maxAttempts);
  }

  private String outputClass = "String"; // TODO this wont always be a string, yeah?
