...
public class HttpApiTest extends Assert {
    ...
    public void testGetMessage() throws Exception {
    	...
    	int count = 0;
    	do {
            response = template.requestBody("http4://localhost:8282/sdp/cbr/message/1", null, String.class);
    ...
    public void testPostMessage() throws Exception {
        ...
        try {
        	Future<String> reply = template.asyncRequestBody("http4://localhost:8282/sdp/cbr/message", content, String.class);
        	reply.get(20, TimeUnit.SECONDS);
		} catch (Exception e) {
