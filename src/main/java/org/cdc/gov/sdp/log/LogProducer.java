...
public class LogProducer extends DefaultProducer {
	...
	private final String[] log_keys = { CBR.SOURCE, CBR.SOURCE_ID, CBR.CBR_ID, CBR.BATCH, CBR.BATCH_INDEX, CBR.MESSAGE, CBR.ROUTE, CBR.TIMESTAMP };	
		...
		try {
			...
			for (String h : headers) {
	        	if (source_headers.get(h) != null) {
	        		...
	        		System.out.println("MISSING HEADER "+h);
			...
			System.out.println("This is where shit got fucked up");
			e.printStackTrace();
		}
	}
}
