...
public class SDPMessage implements Cloneable {
	 ...
	 * the index of the message inside the batch. Index position starts at 0.
	 * This field has no meaning if the batch property is set to false or is not
	 * included
	 */
	...
	/**
	 * The CBR identifier for the message. The general case for this field will
	 * be a concatenation of the source, source_id and batch_index if
	 * applicable",
	 */
	private String id;
	 ...
	 * intended recipient of the message. If this information cannot be derived
	 * from the source this field will be null.
	 */
	private String recipient;

	/**
	 * If available from the source this will contain the information about the
	 * sender of the message. If this information cannot be derived from the
	 * source this filed will be null
	 */
	 ...
	 * message
	 */
	private Map source_attributes = new HashMap();
	 ...
	 * formatted as defined by RFC3339, e.g. 1985-04-12T23:20:50.52Z for times
	 * in UTC or 1996-12-19T16:39:57-08:00 for times in other time zones. If
	 * this information is not available the field will be null.
	 */
