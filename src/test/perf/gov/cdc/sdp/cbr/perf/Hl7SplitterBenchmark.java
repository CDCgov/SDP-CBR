...
public class Hl7SplitterBenchmark {
  ...
  private static Message generateMessage(int batchSize){
	...
	private static String generateBatch(int size){
		...
		buff.append("FHS|^~\\&|^^|The Iowa Division ^2.16.840.1.114222.4.1.3635^ISO|^^|The Iowa Division ^2.16.840.1.114222.4.1.3635^ISO|39130010134019+0-32400000|||||\n");
		buff.append("BHS|^~\\&|^^|The Iowa Division ^2.16.840.1.114222.4.1.3635^ISO|^^|The Iowa Division ^2.16.840.1.114222.4.1.3635^ISO|39130010134019+0-32400000|||||\n");
		for(int i =0; i< size; i++){
			buff.append("MSH|^~\\&|ACDP^2.16.840.1.114222.4.1.3676^ISO|OR-DHS^2.16.840.1.114222.4.1.3676^ISO|PHINCDS^2.16.840.1.114222.4.3.2.10^ISO|PHIN^2.16.840.1.114222^ISO|20170823102635||ORU^R01^ORU_R01|20170823-OR-000515170|P|2.5.1|||||||||NOTF_ORU_v3.0^PHINProfileID^2.16.840.1.114222.4.10.3^ISO~Generic_MMG_V2.0^PHINMsgMapID^2.16.840.1.114222.4.10.4^ISO~FDD_MMG_V1.0^PHINMsgMapID^2.16.840.1.114222.4.10.4^ISO\n" +
