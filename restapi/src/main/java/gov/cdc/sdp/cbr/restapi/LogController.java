...
public class LogController {
  ...
  @ResponseBody
  public String getTraceLog(@PathVariable("cbrId") String cbrId) throws InvalidObjectException, SQLException {
  ...
  @ResponseBody
  public String getTraceLogByIdAndSource(@RequestParam("id") String id, @RequestParam("source") String source)
      throws InvalidObjectException, SQLException {
  ...
  @ResponseBody
  public String getBatchTraceLog(@PathVariable("batchId") String batchId) throws InvalidObjectException, SQLException {
  ...
  @ResponseBody
  public String getBatchTraceLogByIdAndSource(@RequestParam("batchId") String batchId,
  ...
  @ResponseBody
  public String getMessageStatus(@PathVariable("cbrId") String cbrId) throws InvalidObjectException, SQLException {
  ...
  @ResponseBody
  public String getMessageStatus(@RequestParam("id") String id, @RequestParam("source") String source)
      throws InvalidObjectException, SQLException {
  ...
  @ResponseBody
  public String getBatchMessageStatus(@PathVariable("batchId") String batchId) throws SQLException, IOException {
  ...
  @ResponseBody
  public String getBatchStatus(@RequestParam("id") String id, @RequestParam("source") String source)
      throws InvalidObjectException, SQLException {
