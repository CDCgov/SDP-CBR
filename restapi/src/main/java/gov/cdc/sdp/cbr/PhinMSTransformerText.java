...
public class PhinMSTransformerText implements Processor {

  private static final Logger LOG = LoggerFactory.getLogger(PhinMSTransformerText.class);
...
//    }
    ...
    myMap.put("recipientId", "recipient");
    myMap.put("fromPartyId", "REST");
    myMap.put("receivedTime", "");
