...
public interface CBR {
  /*
   * Identifies the source system from which CBR received the message. For the CDC
   * PHIN- MS the value will be PHIN_MS.
   */
  ...
  /*
   * Specifies whether the message was part of a batch of messages received at the
   * source system. The part will be present if the message is part of a batch,
   * omitted if not.
   */
  String BATCH = "BATCH";
  /*
   ...
   * according to the application/x-www-form-urlencoded media type as defined by
   * HTML 5. CBR_RECEIVED_TIME: The time the message was received by the CBR
   * service, the value is formatted as per SOURCE_RECEIVED_TIME above.
   */
